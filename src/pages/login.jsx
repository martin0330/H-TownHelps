...
const Login = () => {
    ...
    // Using useNavigate to handle redirection after login
    const navigate = useNavigate();

    const onSubmit = (data) => {
        console.log(data);
        
        // Simulate successful login (here you would implement your login logic)
        // If login is successful, navigate to the main page
        navigate("/main");  // Redirect to the MainPage after successful login
    };
